...
public class AddTeacher extends JFrame implements ActionListener {
    ...
    AddTeacher() {
        ...
        ImageIcon headerIcon = new ImageIcon(ClassLoader.getSystemResource("icons/info.png"));
        Image headerImage = headerIcon.getImage().getScaledInstance(30, 30, Image.SCALE_DEFAULT);
        ImageIcon headerImageIcon = new ImageIcon(headerImage);
        JLabel headerLabel = new JLabel(headerImageIcon);
        headerLabel.setBounds(210, 44, 30, 30);
        add(headerLabel);
        ...
        lblempId.setFont(new Font("SansSerif", Font.BOLD, 15));
        add(lblempId);
        
        labelempId = new JLabel("101"+first4);
        labelempId.setBounds(200, 200, 200, 30);
        labelempId.setFont(new Font("SansSerif", Font.BOLD, 15));
        add(labelempId);
        ...
        submit.setFont(new java.awt.Font("SansSerif", Font.BOLD, 15));
        submit.setForeground(new java.awt.Color(0, 0, 0));
        submit.setIcon(new ImageIcon(ClassLoader.getSystemResource("icons/correct.png")));
        ...
        cancel.setIcon(new ImageIcon(ClassLoader.getSystemResource("icons/can.png")));
        cancel.setFont(new java.awt.Font("SansSerif", Font.BOLD, 15));
