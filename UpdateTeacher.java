...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    UpdateTeacher() {
       ...
       setSize(850, 650);
        ...
        lblrollnumber.setFont(new Font("SansSerif", Font.PLAIN, 15));
        add(lblrollnumber);
        ...
        lblfname.setFont(new Font("SansSerif", Font.PLAIN, 15));
        add(lblfname);
        ...
        lblrollno.setFont(new Font("SansSerif", Font.PLAIN, 15));
        add(lblrollno);
        ...
        lbldob.setFont(new Font("SansSerif", Font.PLAIN, 15));
        add(lbldob);
        ...
        lblphone.setFont(new Font("SansSerif", Font.PLAIN, 15));
        add(lblphone);
        ...
        lblx.setFont(new Font("SansSerif", Font.PLAIN, 15));
        add(lblx);
        ...
        lblxii.setFont(new Font("SansSerif", Font.PLAIN, 15));
        add(lblxii);
        ...
        lblaadhar.setFont(new Font("SansSerif", Font.PLAIN, 15));
        add(lblaadhar);
        ...
        lblbranch.setFont(new Font("SansSerif", Font.PLAIN, 15));
        add(lblbranch);
